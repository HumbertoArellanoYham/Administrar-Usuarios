package com.arellano.app;

import com.arellano.app.Repositorio.IntefaceRepositorio;
import com.arellano.app.Repositorio.UsuarioRepositorioImpl;
...
public class Main {
    public static void main(String[] args) {
        try (Connection connection = ConexionBaseDatos.getInstancia()) {
            IntefaceRepositorio<Usuario> repositorio = new UsuarioRepositorioImpl();
            int opcionIndice = 0;
            do {
                ...
                if (opcion == null) {
                    ...
                    switch (opcionIndice) {
                        case 1 -> {
                            ...
                            Usuario usuario = repositorio.buscarId(id);
                            if (usuario != null) {
